...
class bridger(object):
    ...
    def save_model(self, model_dir):
        ...
        np.save(params_saved_path, self.model.params)

    # 模型加载
    def load_model(self, model_dir):
        params_saved_path = os.path.join(model_dir, "params.pdtensor.npy")
        params = np.load(params_saved_path, allow_pickle=True)
        self.model.params = params.item()
